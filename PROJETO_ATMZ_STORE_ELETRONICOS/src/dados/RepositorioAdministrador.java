...
public class RepositorioAdministrador implements IRepositorioAdministrador {
	...
	public void adicionarAdministrador(Administrador administrador) {
		...
		if (existe){
			throw new OperacaoInvalidaException("Email ou ID de '" + administrador.getNome() + "' já foi cadastrado.");
		} 
	...
	public void removerAdministrador(Administrador administrador) {
		if(listaAdm.contains(administrador)) {
			...
			throw new OperacaoInvalidaException("O administrador '" + administrador.getNome() + "' não foi cadastrado no sistema.");
			}
