...
public class PedidoController {
    ...
    public void cancelarPedido(Pedido pedido) {
    	if (pedido == null || pedido.getPagamento().getStatus() != Status.AGUARDANDO_PROCESSAMENTO || pedido.getCliente() == null || pedido.getData() == null || pedido.getItens().isEmpty()){
            return;
        }
        ...
        if (existe){    
            ...
            repositorioPedidos.removerPedido(pedido);  
        }
