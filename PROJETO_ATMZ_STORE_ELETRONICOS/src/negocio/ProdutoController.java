...
public class ProdutoController {
    ...
    public void cadastrarProduto(Produto produto) throws ClasseNulaException, AtributosNulosException{
        if (produto == null) {
        	...
        	throw new AtributosNulosException("O produto tem atributos incompletos ou inválidos.");
        }
